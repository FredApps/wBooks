...
fun InstructionsBlock() {
    Column(modifier = Modifier.fillMaxWidth().padding(horizontal = 16.dp, vertical = 4.dp)) {
        ...
        Text(
            text = "Tap the folder icon to create folders. Drag book titles onto folders to move them to the top of that folder. Drag one book above or below another book in the same folder to reorder the list. The watch syncs these changes automatically.\n\n" +
