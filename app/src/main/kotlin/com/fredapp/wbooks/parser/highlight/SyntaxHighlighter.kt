package com.fredapp.wbooks.parser.highlight

/**
 * Lightweight regex-based syntax colouring for [com.fredapp.wbooks.parser.model.Block.Code] blocks
 * surfaced by [com.fredapp.wbooks.parser.HtmlParser]. Designed for watch: tiny ruleset, no PEG,
...
object SyntaxHighlighter {
    ...
    fun highlight(source: String, language: String? = null): List<Token> {
        // language is currently unused (single ruleset) â€” kept for the API so we can
